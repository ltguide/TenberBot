...
namespace TenberBot.Features.HighFiveFeature.Data.Services;

public interface IHighFiveDataService
{
...
public class HighFiveDataService : IHighFiveDataService
{
    private readonly DataContext dbContext;

    public HighFiveDataService(DataContext dbContext)
    {
